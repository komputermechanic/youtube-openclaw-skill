...
echo -e "${CYAN}============================================${NC}"
echo ""
echo -e "${YELLOW}DISCLAIMER — PLEASE READ BEFORE PROCEEDING${NC}"
echo ""
echo "This script and the OpenClaw YouTube Analytics skill are provided"
echo "strictly 'as is', without warranty of any kind, express or implied,"
echo "including but not limited to warranties of merchantability, fitness"
echo "for a particular purpose, or non-infringement."
echo ""
echo "By proceeding, you acknowledge and agree that:"
echo ""
echo "  1. CREDENTIALS & DATA SECURITY: This script stores your YouTube"
echo "     API key and OAuth credentials locally on your own machine."
echo "     You are solely responsible for securing your device and"
echo "     credentials. Komputer Mechanic has no access to your credentials"
echo "     and accepts no liability for any unauthorised access, data"
echo "     breach, or misuse arising from your use of this script."
echo ""
echo "  2. GOOGLE TERMS OF SERVICE: Your use of the YouTube Data API and"
echo "     YouTube Analytics API is subject to Google's Terms of Service"
echo "     and API policies. You are solely responsible for ensuring your"
echo "     usage complies with Google's terms, quota limits, and applicable"
echo "     laws. Komputer Mechanic accepts no liability for API quota"
echo "     exhaustion, account suspension, or policy violations."
echo ""
echo "  3. NO LIABILITY: To the fullest extent permitted by law, Komputer"
echo "     Mechanic shall not be liable for any direct, indirect, incidental,"
echo "     special, consequential, or punitive damages arising out of or"
echo "     relating to your use of this script, including but not limited to"
echo "     data loss, service interruption, or financial loss."
echo ""
echo "  4. THIRD-PARTY SERVICES: This script interacts solely with Google's"
echo "     APIs on your behalf. Komputer Mechanic does not collect, store,"
echo "     or transmit your data to any third-party server."
echo ""
echo "  5. USE AT YOUR OWN RISK: You assume full responsibility for any"
echo "     consequences resulting from the installation and use of this skill."
echo ""
echo "For help and tutorials, visit: https://komputermechanic.com/"
echo ""
read -p "I have read and agree to the above disclaimer. Proceed? (y/n): " PROCEED_SETUP
echo ""
